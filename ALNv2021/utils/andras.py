...
class Andras:
    ...
    def __init__(self,
                 ...
                 basePath:Path=None,
                 cacheName:str=None,
                 logPipe:callable=None):
        self.app = app
        self.silent = silent
        self.customLogger = customLogger
        if logPipe:
            self.alienLogPipe = logPipe
            self.customLogPipe = self._bridgeLogPipe
    ...
    def _bridgeLogPipe(self,message:str,level:int):
        """"""
        """
        A middle-man function to bridge andras's internal logging calls
        ...
        self.alienLogPipe('andras', message, loggingLevel=alienLvl)
